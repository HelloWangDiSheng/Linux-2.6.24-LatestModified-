...
struct module_attribute
{
    ...
    ssize_t (*store)(struct module_attribute *, struct module *, const char *, size_t count);
...
/* Given an address, look for it in the exception tables. */
static inline const struct exception_table_entry *search_module_extables(unsigned long addr)
{
	return NULL;
}
