...
asmlinkage long sys_setrlimit(unsigned int resource, struct rlimit __user *rlim)
{
	...
	/*新设置资源的最大容许值超过之前的最大容许值，并且当前用户没有设置资源的权限。
	则返回 -EPERM*/
	if ((new_rlim.rlim_max > old_rlim->rlim_max) &&!capable(CAP_SYS_RESOURCE))
		return -EPERM;
	/*如果当前的资源编号是可打开文件数目且新设置的最大可打开文件超出系统设置值，
		则返回-EPERM*/
